...
- users can now delete items from their dashboards
- renting a spot or fulfilling a request now takes the user to a 'message' page (like a confirmation page, but not necessarily confirming)
...
skin before early UI testing
put building in cookie
